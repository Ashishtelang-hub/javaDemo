...
public class Ex2 {
	...
	public static void main(String[] args) {
		...
		List<WebElement> allTabs =  driver.findElements(By.cssSelector("td[class^='navItem preventPanelsHiding navCell']>a"));
		
		for(int i=0; i<allTabs.size(); i++) { // Size() method not executed
			if(allTabs.get(i).getAttribute("class").contains("selected")) { // get() method not exectuded
				System.out.println("Tab "+i+"is selected.");
			}else {
				System.out.println("Tab "+ i + "is Not Selected");
			}
		}
